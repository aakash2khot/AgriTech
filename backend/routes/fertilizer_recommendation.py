...
fertilizer_dic = {
    ...
    'PHigh': [
        "The P value of your soil is high. Please consider the following suggestions:",
    ...
    'Plow': [
        "The P value of your soil is low. Please consider the following suggestions:",
    ...
    'KHigh': [
        "The K value of your soil is high. Please consider the following suggestions:",
...
def fert_recommend():
    ...
    response = '<br>'.join(fertilizer_dic[key])
